resource "aws_sqs_queue" "primary" {
  ...
  fifo_throughput_limit       = var.enable_sqs_fifo_queue ? var.sqs_fifo_throughput_limit : null
  deduplication_scope         = var.enable_sqs_fifo_queue ? var.sqs_fifo_deduplication_scope : null
  content_based_deduplication = var.enable_sqs_fifo_queue ? var.sqs_fifo_content_based_deduplication : null
